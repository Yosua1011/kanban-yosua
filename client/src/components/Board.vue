...
const config = {
  apiKey: 'AIzaSyDVzJ2fQMoxzD4c6RjIyKCW8kK5E6t2k_A',
  authDomain: 'kanbanyosua.firebaseapp.com',
  databaseURL: 'https://kanbanyosua.firebaseio.com',
  projectId: 'kanbanyosua',
  storageBucket: 'kanbanyosua.appspot.com',
  messagingSenderId: '430081238495'
}
